...
public class AzureServiceBusTopicController {
	...
	public String receiveMessage() {
		Configuration config = ServiceBusConfiguration.configureWithSASAuthentication("sfg8qv-servicebus",
				"RootManageSharedAccessKey", "nHV07REq3/XjjwZlFydwnxF+yNMcoMqEQWqZvU44K10=", ".servicebus.windows.net");
