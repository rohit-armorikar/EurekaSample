...
public class FlightService {
	...
	public void saveFlightDetails( FlightSearchData objFlightSearchData ) throws IOException,
    DocumentClientException
	{
		
		createDatabaseIfNotExists("FlightDB");
		createDocumentCollectionIfNotExists("FlightDB", "FlightDBCollection");
		createFlightSearchDocumentIfNotExists( "FlightDB", "FlightDBCollection",objFlightSearchData);
	...
	private void createFlightSearchDocumentIfNotExists(String databaseName, String collectionName, FlightSearchData objFlightSearchData )
        ...
        try {
            String documentLink = String.format("/dbs/%s/colls/%s/docs/%s", databaseName, collectionName, objFlightSearchData.getId());
